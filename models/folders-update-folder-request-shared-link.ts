...
import { FoldersUpdateFolderRequestSharedLinkAllOf } from './folders-update-folder-request-shared-link-all-of';
import { FoldersUpdateFolderRequestSharedLinkAllOfPermissions } from './folders-update-folder-request-shared-link-all-of-permissions';

/**
 * 
 * @export
 * @interface FoldersUpdateFolderRequestSharedLink
 */
export interface FoldersUpdateFolderRequestSharedLink {
    /**
     ...
     * @type {string}
     * @memberof FoldersUpdateFolderRequestSharedLink
     */
    'access'?: FoldersUpdateFolderRequestSharedLinkAccessEnum;
    /**
    ...
    /**
     * 
     * @type {FoldersUpdateFolderRequestSharedLinkAllOfPermissions}
     * @memberof FoldersUpdateFolderRequestSharedLink
     */
    'permissions'?: FoldersUpdateFolderRequestSharedLinkAllOfPermissions;
}

type FoldersUpdateFolderRequestSharedLinkAccessEnum = 'open' | 'company' | 'collaborators'
