 ...
 * 
 * @export
 * @interface SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions
 */
export interface SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions {
    /**
     * If the shared link allows for downloading of files. This can only be set when `access` is set to `open` or `company`.
     * @type {boolean}
     * @memberof SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions
     */
