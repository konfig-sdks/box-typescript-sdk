 ...
 * @export
 * @interface ShieldInformationBarrierSegmentMembersAllOf
 */
export interface ShieldInformationBarrierSegmentMembersAllOf {
    /**
     ...
     * @type {number}
     * @memberof ShieldInformationBarrierSegmentMembersAllOf
     */
    'limit'?: number;
    /**
