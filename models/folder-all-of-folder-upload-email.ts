 ...
 * 
 * @export
 * @interface FolderAllOfFolderUploadEmail
 */
export interface FolderAllOfFolderUploadEmail {
    /**
     ...
     * @type {string}
     * @memberof FolderAllOfFolderUploadEmail
     */
    'access'?: FolderAllOfFolderUploadEmailAccessEnum;
    /**
...
type FolderAllOfFolderUploadEmailAccessEnum = 'open' | 'collaborators'
