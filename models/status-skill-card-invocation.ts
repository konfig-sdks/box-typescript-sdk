 ...
 * @export
 * @interface StatusSkillCardInvocation
 */
export interface StatusSkillCardInvocation {
    /**
     * `skill_invocation`
     * @type {string}
     * @memberof StatusSkillCardInvocation
     */
...
type StatusSkillCardInvocationTypeEnum = 'skill_invocation'
