 ...
 * 
 * @export
 * @interface TrashFolderParent
 */
export interface TrashFolderParent {
    /**
     ...
     * @memberof TrashFolderParent
     */
    'type': TrashFolderParentTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof TrashFolderParent
...
type TrashFolderParentTypeEnum = 'folder'
