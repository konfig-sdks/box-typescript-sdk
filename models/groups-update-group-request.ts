 ...
 * 
 * @export
 * @interface GroupsUpdateGroupRequest
 */
export interface GroupsUpdateGroupRequest {
    /**
     * A human readable description of the group.
     * @type {string}
     * @memberof GroupsUpdateGroupRequest
     */
    'description'?: string;
    /**
     ...
     * @memberof GroupsUpdateGroupRequest
     */
    'invitability_level'?: GroupsUpdateGroupRequestInvitabilityLevelEnum;
    /**
     ...
     * @memberof GroupsUpdateGroupRequest
     */
    'member_viewability_level'?: GroupsUpdateGroupRequestMemberViewabilityLevelEnum;
}

type GroupsUpdateGroupRequestInvitabilityLevelEnum = 'admins_only' | 'admins_and_members' | 'all_managed_users'
type GroupsUpdateGroupRequestMemberViewabilityLevelEnum = 'admins_only' | 'admins_and_members' | 'all_managed_users'
