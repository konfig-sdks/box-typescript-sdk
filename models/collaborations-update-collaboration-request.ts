 ...
 * 
 * @export
 * @interface CollaborationsUpdateCollaborationRequest
 */
export interface CollaborationsUpdateCollaborationRequest {
    /**
     * The level of access granted.
     * @type {string}
     * @memberof CollaborationsUpdateCollaborationRequest
     */
    'role': CollaborationsUpdateCollaborationRequestRoleEnum;
    /**
     * <!--alex ignore reject--> Set the status of a `pending` collaboration invitation, effectively accepting, or rejecting the invite.
     * @type {string}
     * @memberof CollaborationsUpdateCollaborationRequest
     */
    'status'?: CollaborationsUpdateCollaborationRequestStatusEnum;
    /**
...
type CollaborationsUpdateCollaborationRequestRoleEnum = 'editor' | 'viewer' | 'previewer' | 'uploader' | 'previewer uploader' | 'viewer uploader' | 'co-owner' | 'owner'
type CollaborationsUpdateCollaborationRequestStatusEnum = 'pending' | 'accepted' | 'rejected'
