 ...
 * 
 * @export
 * @interface FileRequestFolder
 */
export interface FileRequestFolder {
    /**
     ...
     * @memberof FileRequestFolder
     */
    'type': FileRequestFolderTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof FileRequestFolder
...
type FileRequestFolderTypeEnum = 'folder'
