...
import { FileOrFolderScopeObjectAllOf } from './file-or-folder-scope-object-all-of';
import { FileVersionMini } from './file-version-mini';

/**
 * 
 * @export
 * @interface FileOrFolderScopeObject
 */
export interface FileOrFolderScopeObject {
    /**
     ...
     * @type {string}
     * @memberof FileOrFolderScopeObject
     */
    'id': string;
    /**
     ...
     * @memberof FileOrFolderScopeObject
     */
    'type': FileOrFolderScopeObjectTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof FileOrFolderScopeObject
...
type FileOrFolderScopeObjectTypeEnum = 'file'
