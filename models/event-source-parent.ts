 ...
 * 
 * @export
 * @interface EventSourceParent
 */
export interface EventSourceParent {
    /**
     ...
     * @memberof EventSourceParent
     */
    'type': EventSourceParentTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof EventSourceParent
...
type EventSourceParentTypeEnum = 'folder'
