 ...
 * @export
 * @interface FolderUploadEmail1
 */
export interface FolderUploadEmail1 {
    /**
     ...
     * @type {string}
     * @memberof FolderUploadEmail1
     */
    'access'?: FolderUploadEmail1AccessEnum;
}

type FolderUploadEmail1AccessEnum = 'open' | 'collaborators'
