...
import { FilesUpdateFileRequestSharedLinkAllOf } from './files-update-file-request-shared-link-all-of';
import { FilesUpdateFileRequestSharedLinkAllOfPermissions } from './files-update-file-request-shared-link-all-of-permissions';

/**
 * 
 * @export
 * @interface FilesUpdateFileRequestSharedLink
 */
export interface FilesUpdateFileRequestSharedLink {
    /**
     ...
     * @type {string}
     * @memberof FilesUpdateFileRequestSharedLink
     */
    'access'?: FilesUpdateFileRequestSharedLinkAccessEnum;
    /**
...
type FilesUpdateFileRequestSharedLinkAccessEnum = 'open' | 'company' | 'collaborators'
