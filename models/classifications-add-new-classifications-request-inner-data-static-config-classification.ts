 ...
 * @export
 * @interface ClassificationsAddNewClassificationsRequestInnerDataStaticConfigClassification
 */
export interface ClassificationsAddNewClassificationsRequestInnerDataStaticConfigClassification {
    /**
     * A longer description of the classification.
     * @type {string}
     * @memberof ClassificationsAddNewClassificationsRequestInnerDataStaticConfigClassification
     */
