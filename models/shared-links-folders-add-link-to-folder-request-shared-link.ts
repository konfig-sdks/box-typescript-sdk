...
import { SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions } from './shared-links-folders-add-link-to-folder-request-shared-link-permissions';
 ...
 * @export
 * @interface SharedLinksFoldersAddLinkToFolderRequestSharedLink
 */
export interface SharedLinksFoldersAddLinkToFolderRequestSharedLink {
    /**
     ...
     * @type {string}
     * @memberof SharedLinksFoldersAddLinkToFolderRequestSharedLink
     */
    'access'?: SharedLinksFoldersAddLinkToFolderRequestSharedLinkAccessEnum;
    /**
    ...
    /**
     * 
     * @type {SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions}
     * @memberof SharedLinksFoldersAddLinkToFolderRequestSharedLink
     */
    'permissions'?: SharedLinksFoldersAddLinkToFolderRequestSharedLinkPermissions;
}

type SharedLinksFoldersAddLinkToFolderRequestSharedLinkAccessEnum = 'open' | 'company' | 'collaborators'
