 ...
 * @export
 * @interface WebLinksUpdateObjectRequestSharedLink
 */
export interface WebLinksUpdateObjectRequestSharedLink {
    /**
     ...
     * @type {string}
     * @memberof WebLinksUpdateObjectRequestSharedLink
     */
    'access'?: WebLinksUpdateObjectRequestSharedLinkAccessEnum;
    /**
...
type WebLinksUpdateObjectRequestSharedLinkAccessEnum = 'open' | 'company' | 'collaborators'
