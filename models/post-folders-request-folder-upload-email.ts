...
import { FolderUploadEmail1 } from './folder-upload-email1';

/**
 * 
 * @export
 * @interface PostFoldersRequestFolderUploadEmail
 */
export interface PostFoldersRequestFolderUploadEmail {
    /**
     ...
     * @type {string}
     * @memberof PostFoldersRequestFolderUploadEmail
     */
    'access'?: PostFoldersRequestFolderUploadEmailAccessEnum;
}

type PostFoldersRequestFolderUploadEmailAccessEnum = 'open' | 'collaborators'
