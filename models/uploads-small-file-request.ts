...
import { UploadsSmallFileRequestAttributes } from './uploads-small-file-request-attributes';

/**
 * 
 * @export
 * @interface UploadsSmallFileRequest
 */
export interface UploadsSmallFileRequest {
    /**
     * 
     * @type {UploadsSmallFileRequestAttributes}
     * @memberof UploadsSmallFileRequest
     */
