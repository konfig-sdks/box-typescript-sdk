 ...
 * @export
 * @interface ShieldInformationBarrierSegmentRestrictionsAllOf
 */
export interface ShieldInformationBarrierSegmentRestrictionsAllOf {
    /**
     ...
     * @type {number}
     * @memberof ShieldInformationBarrierSegmentRestrictionsAllOf
     */
    'limit'?: number;
    /**
