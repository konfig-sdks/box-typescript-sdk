 ...
 * @export
 * @interface TranscriptSkillCardInvocation
 */
export interface TranscriptSkillCardInvocation {
    /**
     * `skill_invocation`
     * @type {string}
     * @memberof TranscriptSkillCardInvocation
     */
...
type TranscriptSkillCardInvocationTypeEnum = 'skill_invocation'
