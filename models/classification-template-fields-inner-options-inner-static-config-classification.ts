 ...
 * @export
 * @interface ClassificationTemplateFieldsInnerOptionsInnerStaticConfigClassification
 */
export interface ClassificationTemplateFieldsInnerOptionsInnerStaticConfigClassification {
    /**
     * A longer description of the classification.
     * @type {string}
     * @memberof ClassificationTemplateFieldsInnerOptionsInnerStaticConfigClassification
     */
