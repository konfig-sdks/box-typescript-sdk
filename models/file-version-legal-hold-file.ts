 ...
 * 
 * @export
 * @interface FileVersionLegalHoldFile
 */
export interface FileVersionLegalHoldFile {
    /**
     ...
     * @type {string}
     * @memberof FileVersionLegalHoldFile
     */
    'id': string;
    /**
     ...
     * @memberof FileVersionLegalHoldFile
     */
    'type': FileVersionLegalHoldFileTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof FileVersionLegalHoldFile
...
type FileVersionLegalHoldFileTypeEnum = 'file'
