...
import { SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions } from './shared-links-web-links-update-shared-link-request-shared-link-permissions';

/**
 * The settings for the shared link to update.
 * @export
 * @interface SharedLinksWebLinksUpdateSharedLinkRequestSharedLink
 */
export interface SharedLinksWebLinksUpdateSharedLinkRequestSharedLink {
    /**
     ...
     * @type {string}
     * @memberof SharedLinksWebLinksUpdateSharedLinkRequestSharedLink
     */
    'access'?: SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkAccessEnum;
    /**
    ...
    /**
     * 
     * @type {SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions}
     * @memberof SharedLinksWebLinksUpdateSharedLinkRequestSharedLink
     */
    'permissions'?: SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkPermissions;
}

type SharedLinksWebLinksUpdateSharedLinkRequestSharedLinkAccessEnum = 'open' | 'company' | 'collaborators'
