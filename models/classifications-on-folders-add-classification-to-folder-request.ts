 ...
 * 
 * @export
 * @interface ClassificationsOnFoldersAddClassificationToFolderRequest
 */
export interface ClassificationsOnFoldersAddClassificationToFolderRequest {
    /**
     ...
     * @type {string}
     * @memberof ClassificationsOnFoldersAddClassificationToFolderRequest
     */
