...
export interface SkillInvocationSource {
     ...
     * @type {string}
     * @memberof SkillInvocationSource
     */
    'id': string;
    /**
     ...
     * @memberof SkillInvocationSource
     */
    'type': SkillInvocationSourceTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof SkillInvocationSource
     ...
     * @memberof SkillInvocationSource
     */
    'item_status'?: SkillInvocationSourceItemStatusEnum;
    /**
     * 
...
type SkillInvocationSourceTypeEnum = 'folder'
type SkillInvocationSourceItemStatusEnum = 'active' | 'trashed' | 'deleted'
