 ...
 * @export
 * @interface AMetadataInstanceUpdateOperation1
 */
export interface AMetadataInstanceUpdateOperation1 {
    /**
     * The type of change to perform on the template. Some of these are hazardous as they will change existing templates.
     * @type {string}
     * @memberof AMetadataInstanceUpdateOperation1
     */
    'op'?: AMetadataInstanceUpdateOperation1OpEnum;
    /**
...
type AMetadataInstanceUpdateOperation1OpEnum = 'add' | 'replace' | 'remove' | 'test' | 'move' | 'copy'
