...
import { SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkPermissions } from './shared-links-folders-update-folder-shared-link-request-shared-link-permissions';

/**
 * The settings for the shared link to update.
 * @export
 * @interface SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink
 */
export interface SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink {
    /**
     ...
     * @type {string}
     * @memberof SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink
     */
    'access'?: SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkAccessEnum;
    /**
    ...
    /**
     * 
     * @type {SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkPermissions}
     * @memberof SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLink
     */
    'permissions'?: SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkPermissions;
}

type SharedLinksFoldersUpdateFolderSharedLinkRequestSharedLinkAccessEnum = 'open' | 'company' | 'collaborators'
