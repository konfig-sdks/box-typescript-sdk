...
import { FoldersCreateCopyRequestParent } from './folders-create-copy-request-parent';

/**
 * 
 * @export
 * @interface FoldersCreateCopyRequest
 */
export interface FoldersCreateCopyRequest {
    /**
     ...
     * @type {string}
     * @memberof FoldersCreateCopyRequest
     */
    'name'?: string;
    /**
     * 
     * @type {FoldersCreateCopyRequestParent}
     * @memberof FoldersCreateCopyRequest
     */
