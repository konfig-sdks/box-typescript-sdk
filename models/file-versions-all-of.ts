 ...
 * @export
 * @interface FileVersionsAllOf
 */
export interface FileVersionsAllOf {
    /**
     ...
     * @type {Array<FileVersionsAllOfOrder>}
     * @memberof FileVersionsAllOf
     */
    'order'?: Array<FileVersionsAllOfOrder>;
}
