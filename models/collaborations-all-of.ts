 ...
 * @export
 * @interface CollaborationsAllOf
 */
export interface CollaborationsAllOf {
    /**
     ...
     * @type {Array<CollaborationsAllOfOrder>}
     * @memberof CollaborationsAllOf
     */
    'order'?: Array<CollaborationsAllOfOrder>;
}
