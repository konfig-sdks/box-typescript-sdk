...
import { FolderUploadEmail } from './folder-upload-email';

/**
 * 
 * @export
 * @interface FoldersUpdateFolderRequestFolderUploadEmail
 */
export interface FoldersUpdateFolderRequestFolderUploadEmail {
    /**
     ...
     * @type {string}
     * @memberof FoldersUpdateFolderRequestFolderUploadEmail
     */
    'access'?: FoldersUpdateFolderRequestFolderUploadEmailAccessEnum;
}

type FoldersUpdateFolderRequestFolderUploadEmailAccessEnum = 'open' | 'collaborators'
