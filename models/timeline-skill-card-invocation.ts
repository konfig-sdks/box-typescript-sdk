 ...
 * @export
 * @interface TimelineSkillCardInvocation
 */
export interface TimelineSkillCardInvocation {
    /**
     * `skill_invocation`
     * @type {string}
     * @memberof TimelineSkillCardInvocation
     */
...
type TimelineSkillCardInvocationTypeEnum = 'skill_invocation'
