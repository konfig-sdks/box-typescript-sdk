 ...
 * 
 * @export
 * @interface TrashWebLinkParent
 */
export interface TrashWebLinkParent {
    /**
     ...
     * @memberof TrashWebLinkParent
     */
    'type': TrashWebLinkParentTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof TrashWebLinkParent
...
type TrashWebLinkParentTypeEnum = 'folder'
