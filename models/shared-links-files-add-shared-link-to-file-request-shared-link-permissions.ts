 ...
 * 
 * @export
 * @interface SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions
 */
export interface SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions {
    /**
     * If the shared link allows for downloading of files. This can only be set when `access` is set to `open` or `company`.
     * @type {boolean}
     * @memberof SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions
     */
