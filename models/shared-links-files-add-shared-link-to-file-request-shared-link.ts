...
import { SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions } from './shared-links-files-add-shared-link-to-file-request-shared-link-permissions';

/**
 * The settings for the shared link to create on the file. Use an empty object (`{}`) to use the default settings for shared links.
 * @export
 * @interface SharedLinksFilesAddSharedLinkToFileRequestSharedLink
 */
export interface SharedLinksFilesAddSharedLinkToFileRequestSharedLink {
    /**
     ...
     * @type {string}
     * @memberof SharedLinksFilesAddSharedLinkToFileRequestSharedLink
     */
    'access'?: SharedLinksFilesAddSharedLinkToFileRequestSharedLinkAccessEnum;
    /**
    ...
    /**
     * 
     * @type {SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions}
     * @memberof SharedLinksFilesAddSharedLinkToFileRequestSharedLink
     */
    'permissions'?: SharedLinksFilesAddSharedLinkToFileRequestSharedLinkPermissions;
}

type SharedLinksFilesAddSharedLinkToFileRequestSharedLinkAccessEnum = 'open' | 'company' | 'collaborators'
